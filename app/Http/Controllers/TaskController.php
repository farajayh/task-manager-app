...
class TaskController extends Controller
{
    ...
    {
        //set methods that require authentication
    ...
    public function store(TaskRequest  $request)
    {
        ...
        if($task->save()){
            ...
            //fire event for task creation
            event(new TaskEvent(json_encode($response)));
